...
```basic
0sY58692:m=16:dIc(m):fOz=1tom:rEc(z):nE:dA.,6,9,11,4,14,5,3,13,7,1,10,12,8,2,15
...
2fOi=1tom:r2=zr*zr:i2=zi*zi:ad=1024+x+v:ifr2+i2>4tH:pOad+s,c(i):pOad,102:nEx,y
3ni=2*zr*zi+ci:zr=r2-i2+cr:zi=ni:nE:ify<25tHpOad+s,0:pOad,160:nEx,y
```
...
60 nEx,y
70 sY49152:fOt=1to100:nE:gO100
